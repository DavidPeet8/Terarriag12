...
public class Constants {
    ...
    //how will this go in constants? when will these get created?
//    public static final int INITSCREENWIDH = Gdx.graphics.getWidth();
//    public static final int INITSCREENHEIGHT = Gdx.graphics.getHeight();
