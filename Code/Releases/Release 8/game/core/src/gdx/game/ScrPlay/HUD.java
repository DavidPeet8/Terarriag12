...
public class HUD implements Disposable {
    ...
    public void update(SpriteDiscrete sprPlayer, InventoryObj inventory){
        ...
        batch.begin();
        Fonts.fontF1.draw(batch,"HEALTH: " , 100, 120);
        Fonts.fontF1.draw(batch, Integer.toString(sprPlayer.getHealth()), 180, 120);
        Fonts.fontF1.draw(batch,"MANA: " , 100, 70);
        Fonts.fontF1.draw(batch, Integer.toString(sprPlayer.getMana()), 180, 70);
