...
public class SpriteDiscrete extends Sprite {
    ...
    double dAttemptMoveX, dAttemptMoveY, dAttemptFullMoveX, dAttemptFullMoveY;
    double dW, dH;
    double dAccel;
    ...
    public void checkMove(SpriteExtended[][] arSpriteExtended_) {
        dAttemptFullMoveX = dSpeed;
        dAttemptFullMoveY = dVel;
        dAttemptMoveX = dAttemptFullMoveX;
        dAttemptMoveY = dAttemptFullMoveY;

        for (int x = 0; x < (int) dAttemptFullMoveX / (int) dW; x++) {
            for (int y = 0; x < (int) dAttemptFullMoveY / (int) dH; y++) {
                dAttemptMoveX = (int) dAttemptFullMoveX / (int) dW;
                dAttemptMoveY = (int) dAttemptFullMoveY / (int) dH;
